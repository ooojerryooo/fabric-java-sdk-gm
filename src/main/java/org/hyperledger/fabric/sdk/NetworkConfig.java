...
import org.hyperledger.fabric.sdk.security.PEMPrivateKeyDecoder;
...
//        }
    ...
    private static PrivateKey getPrivateKeyFromString(String data) throws IOException {
        try {
            PEMPrivateKeyDecoder decoder = PEMPrivateKeyDecoder.getInstance();
            return decoder.getPrivateKeyFromBytes(data);
        } catch (Exception var3) {
            throw new IOException("Failed to convert private key bytes", var3);
        }
    }
