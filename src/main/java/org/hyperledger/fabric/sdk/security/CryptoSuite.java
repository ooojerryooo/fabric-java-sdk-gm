...
public interface CryptoSuite {
    ...
    /**
     * add by bryan, Convert bytes in PEM format to PrivateKey.
     *
     * @param certBytes
     * @return Certificate
     * @throws CryptoException
     */
    PrivateKey bytesToPrivateKey(byte[] certBytes) throws CryptoException, Exception;
    ...
    class Factory {
        ...
        public static CryptoSuite getCryptoSuite(String hashalg) throws IllegalAccessException, InstantiationException,
                ClassNotFoundException, CryptoException, InvalidArgumentException, NoSuchMethodException,
                InvocationTargetException {
            Properties properties = new Properties();
            properties.setProperty("org.hyperledger.fabric.sdk.hash_algorithm",hashalg);
            return CryptoSuiteFactory.getDefault().getCryptoSuite(properties);
        }
