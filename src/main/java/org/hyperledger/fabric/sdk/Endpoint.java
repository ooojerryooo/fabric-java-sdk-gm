...
class Endpoint {
    ...
    Endpoint(CryptoSuite cp, String url, Properties properties) {
    ...
    static Endpoint createEndpoint(CryptoSuite cryptoSuite, String url, Properties properties) {

        return new Endpoint(cryptoSuite, url, properties);
